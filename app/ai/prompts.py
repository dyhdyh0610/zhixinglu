...
### 操作建议
一句话说明：现在该不该买/卖，什么态度（积极买入 / 可以关注 / 建议观望 / 建议减仓 / 建议清仓）。

### 怎么买
- 如果值得买：给出具体买入价格区间（结合DCF估值、技术支撑位、估值分位），建议仓位（轻仓/半仓/重仓），分批建仓节奏
- 如果不值得买：说明理由，列出你愿意开始关注的触发价格

### 怎么卖
- 给出目标卖出价格区间（结合DCF估值、技术压力位、历史估值上限）
- 止损位建议

### 后续研判
- 短期（1-3个月）：一句话判断 + 关键催化剂
- 中期（3-12个月）：一句话判断 + 核心变量

用日常语言，每段不超过80字。直接输出，不要加额外标题。""" }
    ]
